...
import '../home_screen/New_home.dart';
  ...
  void dispose() {
   ...
   ExitConfirmationDialog(){
     return AlertDialog(
       ...
       title: Text('Exit App',style: TextStyle(color: AppColors.textclr),),
       content: Text('Are you sure you want to exit?',style: TextStyle(color: AppColors.textclr),),
       actions: [
         TextButton(
           child: Container(
             height: 25,width: 50,
        ...
        child: WillPopScope(
          ...
          child: Scaffold(
            ...
            bottomNavigationBar: TabBar(
              ...
              labelStyle: TextStyle(fontSize: 8.5),
